...
> = {
  Persons: {
    ...
    transcriptHighlightClassName:
      "bg-rose-300/25 text-rose-200 ring-1 ring-inset ring-rose-300/35",
  },
  Places: {
    ...
    transcriptHighlightClassName:
      "bg-green-300/25 text-green-200 ring-1 ring-inset ring-green-300/35",
  },
  Commodities: {
    ...
    transcriptHighlightClassName:
      "bg-orange-300/25 text-orange-200 ring-1 ring-inset ring-orange-300/35",
  },
  Documents: {
    ...
    transcriptHighlightClassName:
      "bg-amber-300/25 text-amber-200 ring-1 ring-inset ring-amber-300/35",
  },
  Dates: {
    ...
    transcriptHighlightClassName:
      "bg-sky-300/25 text-sky-200 ring-1 ring-inset ring-sky-300/35",
  },
  Ships: {
    ...
    transcriptHighlightClassName:
      "bg-stone-300/25 text-stone-200 ring-1 ring-inset ring-stone-300/35",
  },
  Organisations: {
    ...
    transcriptHighlightClassName:
      "bg-purple-300/25 text-purple-200 ring-1 ring-inset ring-purple-300/35",
  },
  Polities: {
    ...
    transcriptHighlightClassName:
      "bg-neutral-300/20 text-neutral-300 ring-1 ring-inset ring-neutral-300/30",
  },
  Quantity: {
    rowClassName: "bg-neutral-400/8",
    subRowClassName: "bg-neutral-400/6",
