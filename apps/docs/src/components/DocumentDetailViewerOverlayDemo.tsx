        ...
        >
          ...
          <div className="flex items-center gap-s8">
            <span className="group/jump-doc relative inline-flex">
              ...
              <span
                aria-hidden="true"
                className="pointer-events-none absolute right-0 top-[calc(100%+var(--s8))] z-70 w-64 max-w-72 -translate-y-1 overflow-hidden border border-brand-white/10 bg-neutral-700 p-s12 text-left font-sans text-[10px] leading-3 text-brand-white opacity-0 shadow-[0_6px_14px_rgba(0,0,0,0.25),0_25px_25px_rgba(0,0,0,0.22),0_56px_34px_rgba(0,0,0,0.13),0_100px_40px_rgba(0,0,0,0.04)] transition-[opacity,transform] duration-75 ease-out group-focus-within/jump-doc:translate-y-0 group-focus-within/jump-doc:opacity-100 group-hover/jump-doc:translate-y-0 group-hover/jump-doc:opacity-100 motion-reduce:transition-none"
              >
            ...
            <span className="group/jump-scan relative inline-flex">
              ...
              <span
                aria-hidden="true"
                className="pointer-events-none absolute right-0 top-[calc(100%+var(--s8))] z-70 w-64 max-w-72 -translate-y-1 overflow-hidden border border-brand-white/10 bg-neutral-700 p-s12 text-left font-sans text-[10px] leading-3 text-brand-white opacity-0 shadow-[0_6px_14px_rgba(0,0,0,0.25),0_25px_25px_rgba(0,0,0,0.22),0_56px_34px_rgba(0,0,0,0.13),0_100px_40px_rgba(0,0,0,0.04)] transition-[opacity,transform] duration-75 ease-out group-focus-within/jump-scan:translate-y-0 group-focus-within/jump-scan:opacity-100 group-hover/jump-scan:translate-y-0 group-hover/jump-scan:opacity-100 motion-reduce:transition-none"
              >
