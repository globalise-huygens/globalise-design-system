...
export const ENTITY_PREVIEW_CARD_DATA = {
  maccasser: {
    kind: "place",
    title: "Maccasser",
    icon: <IconEntityPlace className="h-s14 w-s14" />,
    badges: ["ner", "lin"],
    placeType: "Harbour city",
    historicalForm: "Macassar / Maccasser",
    region: "South Sulawesi",
    authority: "VOC Celebes records",
    mentions: "34",
  },
  fredrikWillemVanBlijdenberg: {
    kind: "person",
    title: "Fredrik Willem van Blijdenberg",
    icon: <IconEntityPerson className="h-s14 w-s14" />,
    badges: ["ner"],
    role: "Captain",
    affiliation: "Burgerij Vlaardingen",
    civicStatus: "Named official",
    activePeriod: "1787",
    mentions: "12",
  },
  cCraane: {
    ...
    icon: <IconEntityPerson className="h-s14 w-s14" />,
    badges: ["ner"],
    role: "Transfer witness",
    affiliation: "Inventory handover",
    civicStatus: "Named person",
    activePeriod: "1787",
    mentions: "4",
  },
  barendReijke: {
    ...
    icon: <IconEntityPerson className="h-s14 w-s14" />,
    badges: ["ner", "lin"],
    role: "Governor and Director",
    affiliation: "Celebes coast",
    civicStatus: "Addressed recipient",
    activePeriod: "1787",
    mentions: "8",
  },
  celeber: {
    ...
    badges: ["ner"],
    placeType: "Region",
    historicalForm: "Celeber / Celebes",
    region: "Sulawesi",
    authority: "VOC administrative geography",
    mentions: "6",
  },
  april17871: {
    kind: "date",
    title: "April 17871",
    icon: <IconEntityDate className="h-s14 w-s14" />,
    badges: ["ner"],
    normalizedDate: "April 1787",
    calendar: "Gregorian",
    period: "Late 18th century",
    relatedEvent: "Inventory handover record",
    mentions: "5",
  },
  prinsEugenius: {
    kind: "ship",
    title: "Prins Eugenius",
    icon: <IconEntityShip className="h-s14 w-s14" />,
    badges: ["ner", "lin"],
    shipType: "Schip",
    built: "1703",
    laidUp: "1727",
  ...
  voc: {
    kind: "organisation",
    title: "VOC",
    icon: <IconEntityOrganisation className="h-s14 w-s14" />,
    badges: ["ner", "lin"],
    organisationType: "Trading company",
    jurisdiction: "Dutch Republic",
    founded: "1602",
    region: "Indian Ocean world",
    mentions: "71",
  },
  cinnamon: {
    kind: "commodity",
    title: "Cinnamon",
    icon: <IconEntityCommodity className="h-s14 w-s14" />,
    badges: ["ner"],
    commodityType: "Spice",
    origin: "Ceylon",
    unit: "Bales",
    qualifier: "Trade good",
    mentions: "51",
  },
  inventoryRecord: {
    kind: "document",
    title: "Transfer record",
    icon: <IconEntityDocument className="h-s14 w-s14" />,
    badges: ["ner"],
    documentType: "Inventory record",
    reference: "VOC 1664",
    archiveScan: "23",
    collection: "Incoming letters",
    mentions: "2",
  },
  pageNumber108: {
    kind: "quantity",
    title: "108",
    badges: ["ner"],
    quantityType: "Page number",
    amount: "108",
    unit: "folio",
    context: "Top-of-page marker",
  },
  coastalMeasure: {
    kind: "dimensions",
    title: "Daily usage",
    badges: ["ner"],
    measurementType: "Usage measure",
    value: "Daily",
    unit: "allocation",
    context: "Burgerwagt supplies",
  },
  celebesCoast: {
    kind: "polity",
    title: "Celebes coast",
    icon: <IconEntityOrganisation className="h-s14 w-s14" />,
    badges: ["ner", "lin"],
    polityType: "Colonial jurisdiction",
    region: "South Sulawesi",
    period: "1787",
    authority: "Governor and Director",
    mentions: "3",
  },
} satisfies Record<string, EntityPreviewCardData>;

export type EntityPreviewCardId = keyof typeof ENTITY_PREVIEW_CARD_DATA;
